...
fwrite(coef, "./Data/coef_seqrolling_500_SPY.csv")

# visualization
pdf("./images/coef_seqrolling_500_SPY.pdf", 12,10)
par(mfrow = c(3,5))
plot(coef$r13_lag, type="l", ylab="r13_lag", xaxt = "n", xlab = "",)
plot(coef$r_on, type="l", xaxt = "n", xlab = "", ylab="r_on")
plot(coef$r1, type="l", xaxt = "n", xlab = "", ylab="r1")
