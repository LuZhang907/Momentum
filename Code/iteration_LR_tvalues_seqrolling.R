...
# visualization
pdf("./images/r13_lag_on_1_tvalues_seqrolling_500_SPY.pdf", 6,6)
par(mfrow = c(3,1))
...
pdf("./images/r234_tvalues_seqrolling_500_SPY.pdf", 6,6)
par(mfrow = c(3,1))
...
pdf("./images/r567_tvalues_seqrolling_500_SPY.pdf", 6,6)
par(mfrow = c(3,1))
...
pdf("./images/r8710_tvalues_seqrolling_500_SPY.pdf", 6,6)
par(mfrow = c(3,1))
...
pdf("./images/r1112_tvalues_seqrolling_500_SPY.pdf", 6,6)
par(mfrow = c(3,1))
