...
plot(yearRet$dat.year, yearRet$cum_onfh, type = "b", frame = TRUE, pch = 19, lwd=2,
     lty=1, xlab = "", ylab = "Yearly return", ylim = c(-0.25,1.5))
# Add a second line
lines(yearRet$dat.year, yearRet$cum_alwayslong, pch = 19,
      type = "b", lwd=2, lty=3)
...
plot(yearRet$dat.year, yearRet$cum_on, type = "b",  pch = 19, lwd=2,
     xlab = "", ylab = "Yearly return", ylim = c(-0.25,1.5))
# Add a second line
lines(yearRet$dat.year, yearRet$cum_alwayslong, pch = 19, 
      col = "black", type = "b", lwd=2,lty=3)
# Add a legend to the plot
...
plot(yearRet$dat.year, yearRet$cum_12, type = "b",  pch = 19, lwd=2,
     xlab = "", ylab = "Yearly return", ylim = c(-0.25,1.5))
# Add a second line
lines(yearRet$dat.year, yearRet$cum_alwayslong, pch = 19, 
      col = "black", type = "b", lwd=2, lty=3)
...
#13lag
plot(yearRet$dat.year, yearRet$cum_lag, type = "b",  pch = 19, lwd=2,
      xlab = "", ylab = "Yearly return", ylim = c(-0.25,1.5))
# Add a second line
lines(yearRet$dat.year, yearRet$cum_alwayslong, pch = 19, 
      col = "black", type = "b", lwd=2,lty=3)
...
plot(yearRet$dat.year, yearRet$cum_onfh12, type = "b",  pch = 19, lwd=2,
    xlab = "", ylab = "Yearly return", ylim = c(-0.25,1.5))
# Add a second line
lines(yearRet$dat.year, yearRet$cum_alwayslong, pch = 19, col = "black",
      type = "b", lwd=2,lty=3)
# Add a legend to the plot
...
plot(yearRet$dat.year, yearRet$cum_on12, type = "b",  pch = 19, lwd=2,
     xlab = "", ylab = "Yearly return", ylim = c(-0.25,1.5))
# Add a second line
lines(yearRet$dat.year, yearRet$cum_alwayslong, pch = 19, 
      col = "black", type = "b", lwd=2,lty=3)
...
plot(yearRet$dat.year, yearRet$cum_lagon, type = "b",  pch = 19, lwd=2,
     xlab = "", ylab = "Yearly return", ylim = c(-0.25,1.5))
# Add a second line
lines(yearRet$dat.year, yearRet$cum_alwayslong, pch = 19, 
      col = "black", type = "b", lwd=2,lty=3)
...
plot(yearRet$dat.year, yearRet$cum_lag12, type = "b",  pch = 19, lwd=2,
     xlab = "", ylab = "Yearly return", ylim = c(-0.25,1.5))
# Add a second line
lines(yearRet$dat.year, yearRet$cum_alwayslong, pch = 19, 
      col = "black", type = "b", lwd=2,lty=3)
...
plot(yearRet$dat.year, yearRet$cum_1011, type = "b",  pch = 19, lwd=2,
     xlab = "", ylab = "Yearly return", ylim = c(-0.25,1.5))
# Add a second line
lines(yearRet$dat.year, yearRet$cum_alwayslong, pch = 19, 
      col = "black", type = "b", lwd=2,lty=3)
...
plot(yearRet$dat.year, yearRet$cum_buyandhold, type = "b",  pch = 19, lwd=2,
    xlab = "", ylab = "Yearly return", ylim = c(-0.25,1.5))
# Add a second line
lines(yearRet$dat.year, yearRet$cum_alwayslong, pch = 19, 
      col = "black", type = "b", lwd=2,lty=3)
...
plot(yearRet$dat.year, yearRet$cum_10, type = "b",  pch = 19, lwd=2,
    xlab = "", ylab = "Yearly return", ylim = c(-0.25,1.5))
# Add a second line
lines(yearRet$dat.year, yearRet$cum_alwayslong, pch = 19, 
      col = "black", type = "b", lwd=2,lty=3)
...
plot(yearRet$dat.year, yearRet$cum_11, type = "b",  pch = 19, lwd=2,
    xlab = "", ylab = "Yearly return", ylim = c(-0.25,1.5))
# Add a second line
lines(yearRet$dat.year, yearRet$cum_alwayslong, pch = 19, 
      col = "black", type = "b", lwd=2,lty=3)
